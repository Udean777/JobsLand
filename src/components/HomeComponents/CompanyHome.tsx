...
function CompanyHome() {
    return (
        <div className="hero">
            <div className="hero-content flex flex-col lg:flex-row items-center justify-center max-w-screen-xl mx-auto px-8 my-8 md:mb-8">
                <div className="text-center lg:text-left">
                    <h1 className="text-4xl font-bold mb-4 text-primary">Temukan Kandidat Berkualitas</h1>
                    ...
                    <button className="btn btn-primary text-white">Detail Produk</button>
                </div>

                <img
                    src="/jobs-hunt.png"
                    className="w-full max-w-full lg:max-w-lg rounded-lg mb-8 lg:mb-0 lg:mr-8" alt="Jobs Candidate" />
            </div>
        </div>
    )
}
