        ...
        <div className="flex flex-col min-h-screen pt-16 md:pt-20">
            ...
            <div className="flex justify-center mt-8">
                <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
                    <h2 className="text-xl font-bold mb-4">Daftar sebagai Perusahaan</h2>
                    <h3 className="text-lg font-semibold mb-2">Info Perusahaan</h3>
                    <form>
                        <div className="mb-4">
                            <label className="block text-gray-700">Nama Perusahaan (Usaha) <span className="text-red-500">*</span></label>
                            <input type="text" className="w-full px-3 py-2 border rounded" required />
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700">Nama Penanggung Jawab <span className="text-red-500">*</span></label>
                            <input type="text" className="w-full px-3 py-2 border rounded" required />
                        </div>
                        <div className="mb-4">
                            <label className="block text-gray-700">Nomor HP/Telepon <span className="text-red-500">*</span></label>
                            <input type="tel" className="w-full px-3 py-2 border rounded" required />
                        </div>
                        <h3 className="text-lg font-semibold mb-2">Info Login</h3>
                        <div className="mb-4">
...
export default RegisterForCompany;
